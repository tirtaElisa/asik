<?php
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM tangkapanhasil WHERE id_tangkapan = '$id_tangkapan'");
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Catch Result</h4> <!-- Formulir Ubah Data -->
                                </div>
                                <div class="card-body">
                                    <form action="proses_update_tangkapanhasil.php" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-2">
                                                <input type="hidden" id="id_tangkapan" class="form-control" name="id_tangkapan" value="<?=$row['id_tangkapan'] ?>" />
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-1">
                                            ...
                                            <!-- <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="nama" value="<?=$row['nama'] ?>" placeholder="Nama Pulau" />
                                                </div>
                                            </div> -->
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="pps" class="form-label">Ocean Fishing Port</label>
                                                    <input type="text" class="form-control" name="pps" value="<?=$row['pps'] ?>" placeholder=""></input>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="mb-1">
                                                    <label for="tuna" class="form-label">Tuna</label>
                                                    <input type="text" class="form-control" name="tuna" value="<?=$row['tuna'] ?>" placeholder=""></input>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="mb-1">
                                                    <label for="tongkol" class="form-label">Tongkol</label>
                                                    <input type="text" class="form-control" name="tongkol" value="<?=$row['tongkol'] ?>" placeholder=""></input>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="mb-1">
                                                    <label for="cakalang" class="form-label">Cakalang</label>
                                                    <input type="text" class="form-control" name="cakalang" value="<?=$row['cakalang'] ?>" placeholder=""></input>
                                                </div>
                                            </div>
