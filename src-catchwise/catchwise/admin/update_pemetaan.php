<?php
    ...
    $result      = mysqli_query($koneksi, "SELECT * FROM pemetaan WHERE id_pemetaan = '$id_pemetaan'");
...
<head>
    ...
    <title>Change Data - CatchWise</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                            <h2 class="float-start mb-0">Change Data</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Mapping Data</h4> <!-- Formulir Ubah Data -->
                                </div>
                                <div class="card-body">
                                    <form action="proses_update_pemetaan.php" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-2">
                                                <input type="hidden" class="form-control" name="id_pemetaan" value="<?=$row['id_pemetaan'] ?>" placeholder="" readonly />
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="titik_koordinat" class="form-label">Coordinates</label>
                                                    <input type="text" class="form-control" name="titik_koordinat" value="<?=$row['titik_koordinat'] ?>" placeholder="Coordinates" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="nama_pulau" class="form-label">Port Name</label>
                                                    <input type="text" class="form-control" name="nama_pulau" value="<?=$row['nama_pulau'] ?>" placeholder="Port Name" />
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="spesies_lamun" class="form-label">Description</label>
                                                    <textarea class="form-control" name="spesies_lamun" rows="4" placeholder="Description"><?= htmlspecialchars($row['spesies_lamun']) ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="gmbr_pulau" class="form-label">Image</label>
                                                    <input type="file" class="form-control" name="gmbr_pulau" value="<?=$row['gmbr_pulau'] ?>" placeholder="" />
                                                </div>
                                            </div>
