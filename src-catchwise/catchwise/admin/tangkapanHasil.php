<?php
    ...
    $query  = "SELECT * FROM tangkapanhasil";
...
<head>
    ...
    <title>Fish Catch - CatchWise</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <h2 class="float-start mb-0">Capture Fisheries Production</h2>
                    </div>
                </div>
            </div>
            <div class="content-body">
                <div class="row" id="table-hover-animation">
                    <div class="col-12">
                        ...
                        <a href="insert_tangkapanhasil.php" class="btn btn-primary">Add Data</a>
                                ...
                                <table class="table table-hover-animation" style="min-width: 1500px;"> <!-- style="min-width: 250px;" -->
                                    <thead>
                                        <tr style="text-align: center;">
                                            ...
                                            <th style="min-width: 350px;">Ocean Fishing Port</th>
                                            <th style="min-width: 100px;">Tuna</th>
                                            <th style="min-width: 100px;">Tongkol</th>
                                            <th style="min-width: 100px;">Cakalang</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody style="text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['tuna']; ?></td>
                                            <td><?php echo $row['tongkol']; ?></td>
                                            <td><?php echo $row['cakalang']; ?></td>
                                            <td>
                                                <a href="update_tangkapanhasil.php?id_tangkapan=<?php echo $row['id_tangkapan']; ?> "class="btn btn-sm btn-secondary">Change</a>
                                                <a href=" hapus_tangkapanhasil.php?id_tangkapan=<?php echo $row['id_tangkapan']; ?> "class="btn btn-sm btn-danger" onclick="return confirm('Confident delete data <?php echo $row['nama']; ?> ?')">Delete</a>
                                            </td>   
                                        </tr>
                                        <?php
                                            $i++;
